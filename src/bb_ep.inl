...
// fast 2-bit (4 grayscale mode) for GDEY075T7-D2 (newer model)
const uint8_t epd75_new_gray_init_fast[] PROGMEM = {
    6, UC8151_PWR, 0x07, 0x07, 0x3f, 0x3f, 0x03,
    1, UC8151_PON,
    BUSY_WAIT,
    2, UC8151_PSR, 0x3f,
...
// 20
    ...
    {800, 480, 0, epd75_gray_init, epd75_new_gray_init_fast, NULL, BBEP_4GRAY, BBEP_CHIP_UC81xx, u8Colors_4gray}, // EP75_800x480_4GRAY_GEN2
