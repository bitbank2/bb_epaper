...
// 2.13" 122x250 SSD1681 4-gray mode
const uint8_t epd213g_init_full[] PROGMEM =
{
   0x01, 0x12, // soft reset
   BUSY_WAIT,
   0x04, 0x01, 0xf9, 0x00, 0x00,
...
const uint8_t epd42z_init_sequence_part[] PROGMEM =
{
    0x01, SSD1608_SW_RESET,
    BUSY_WAIT,
    2, 0x3c, 0x80,
    3, 0x21, 0x00, 0x00, // display update control 
    2, 0x3c, 0x80,
    SET_ORIENTATION,
    BUSY_WAIT,
    0x00 // end of table
...
// Use custom LUT to get better grays than the built-in LUT
    91, 0x32, // LUT
    0x9a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // LUT 0
    0x99, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // LUT 1
    0x96, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // LUT 2
    0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // LUT 3
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // LUT VCOM
    0x0a, 0x0a, 0x07, 0x02, 0x00, // phases for 0 A,B,C,D
    0x06, 0x01, 0x04, 0x00, 0x00, // phases for 1 A,B
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, // 2-9 not needed
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    2, 0x3f, 0x07, // LUT END (turns off power, needed to stop it from 'graying')
    BUSY_WAIT,
    0 // end
};
...
//    {792, 272, 0, epd579yr_init_full, epd579yr_init_fast, NULL, BBEP_4COLOR, BBEP_CHIP_UC81xx, u8Colors_4clr_v2}, // EP579YR_792x272
    ...
    {800, 480, 0, epd397_init_full, NULL, epd397_init_part, BBEP_NEEDS_EXTRA_INIT, BBEP_CHIP_SSD16xx, u8Colors_2clr}, // EP397_800x480
